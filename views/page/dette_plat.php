                            ...
                            <div class="row align-items-end">
                                <div class="col-lg-8">
                                    <div class="page-header-title">
                                        ...
                                        <div class="d-inline">
                                            <h5>Dette plat</h5>
                                            <span>la page permet de faire l'inventaire des dettes</span>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Dette plat</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Dette plat</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
...
<script type="text/javascript">
 ...
 $(document).on('click','.voir',function(){
  ...
  new Dialogify('views/script/vente_plat/vente_view.php', options)
   .title('details')
   .showModal();
   ...
   if (id){
     ...
     $.ajax({
       ...
       url:'views/script/vente_plat/vente_up.php',
       method:'POST',
       data:{id:id} ,
       dataType:"json",
     ...
     html_code += "<td  class='item_qt'><input type='number' name='qt[]' id='qt' class='form-control col-md-6 qt' min='1' /><input type='hidden' name='pr[]' id='pr' value='"+pr+"' class='pr' /></td>";
 ...
 var nom=$('.nom').val();
    ...
    nom='client';
      ...
      $.ajax({
       ...
       url:'views/script/vente_plat/vente_voir.php',
       method:'POST',
       data:{item_ds:item_ds, id:id, item_qt:item_qt,  tb:tb,item_pv:item_pv, item_pr:item_pr, nom:nom} ,
 ...
 $(document).on('click','#savv',function(event){
  ...
  $.ajax({
   url:"views/script/vente_plat/vente_insert.php",
   method:"POST",
  data:{item_ds:item_ds, id:id,item_qt:item_qt, tb:tb,item_pv:item_pv, item_pr:item_pr,nom:nom},
   success:function(data){
     if(data){
...
$('#sh').blur(function(){
     ...
     $.ajax({
      url:'views/script/vente_plat/vente_view.php',
      method:"POST",
      data:{num:sh},
      success:function(data)
      {
...
$(document).on('click','.delete',function(event){
    ...
    ok:function(){
      $.ajax({
       ...
       url:'views/script/vente_plat/vente_delete.php',
       method:'POST',
       data:{id:id} ,
       dataType:"json",
       success:function(data){
...
$(document).on('click','.update',function(event){
    ...
    ok:function(){
      $.ajax({
       ...
       url:'views/script/vente_plat/paye.php',
       method:'POST',
       data:{id:id} ,
       dataType:"json",
       success:function(data){
