                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a href="#">Dette boisson</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Dette boisson</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-striped table-bordered table-hover example1" id="simpletable">
                                            ...
                                            <tbody>
                                              <?php 
                                                    ...
                                                    $i=0;
                                                    if($ver_P[7][0]=="vente_boisson" and 
                                                       $ver_P[7][4]==1) {
...
$(document).on('click','.voir',function(){
  ...
  $('.pr').each(function(){
   item_pr.push($(this).val());
      ...
      $.ajax({
       ...
       method:'POST',
       data:{item_ds:item_ds, id:id, item_qt:item_qt, item_qr:item_qr, tb:tb,item_pv:item_pv, item_pr:item_pr,nom:nom} ,
 ...
 $(document).on('click','.savv',function(event){
  ...
  $.ajax({
   ...
   method:"POST",
  data:{item_ds:item_ds, id:id,item_qt:item_qt, item_qr:item_qr, tb:tb,item_pv:item_pv, item_pr:item_pr,nom:nom,stat:stat},
   success:function(data){
     if(data){
         $('#ajouter').modal('hide');
          // Swal.fire(
