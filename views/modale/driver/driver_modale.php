            ...
            <div class="modal-header">
                ...
                <div class="modal-body">
                   <div class="form-row"> 
                      ...
                      <div class="form-row">
                        <div class="form-group col-md-4">
                           <label  style="color:black; font-weight:bold;">Proprietaire</label>
                           <select  name="bs" id="bs" class="form-control" style="border-radius:20px;" required>
                            <option >select</option>
                             <?php 
                                 
                                  $con = dbConnect() ;
                                  $p=$con->prepare('select * from boss where bs_statut="actif" ');
                  ...
                  <div class="form-group col-md-6">
                        ...
                        <textarea class="form-control" id="adresse" style="border-radius:20px;" name="adresse" placeholder="Tapez votre adresse" required></textarea>
                         </div> 
