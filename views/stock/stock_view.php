            ...
            <div class="row">
              <div class="col-md-6 col-sm-6 col-6">
                <div class="btn-group">
                  ...
                  <a href="#" class="btn btn-dark change" style="background-color: #3a3e59; padding: px" id="2">
                    <span class="p-3">Changer le prix en bar</span>
                  </a>

                </div>
                <div class="btn-group">

                  <a href="#" class="btn btn-info change2" id="3">
                  <span class="p-3">Changer le prix en Boite</span>
                  </a>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.change', function(event) {
      var id = $(this).attr("id");
      Dialogify.confirm('voulez-vous vraiment Changer le prix en bar?', {
    ...
    $(document).on('click', '.change2', function(event) {
      var id = $(this).attr("id");
      Dialogify.confirm('voulez-vous vraiment Changer le prix en boite?', {

        ok: function() {
          $.ajax({

            url: 'views/script/stock/change2.php',
            method: 'POST',
            data: {
              id: id
            },
