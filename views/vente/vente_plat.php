          ...
          <div class="row align-items-end">
            <div class="col-lg-8">
              <div class="page-header-title">
                ...
                <div class="d-inline">
                  <h5>Vente de Plats</h5>
                  <span>la page permet de faire la vente des Plats aux clients</span>
                </div>
              </div>
            </div>
            <div class="col-lg-4">
        ...
        <div class="row">
          <div class="col-md-4 col-sm-4">
            <div class="card card-box">
              <div class="card-head">
                <font size="6">
                  <header class="col-sm-6 control-label">PLat</header>
                </font>
              </div>
              <div class="card-body " id="bar-parent">
                ...
                <div style="height: 120px;overflow: auto;">
                  ...
                  $q = all_plat();
                  while ($data = $q->fetch()) { ?>
                    <div class="form-group  col-md-12 bs" id="<?= $data['p_id'] ?>">
                      <img src="<?= $data['p_img'] ?>" style="width: 50px;" class="table-user-thumb" alt="">
